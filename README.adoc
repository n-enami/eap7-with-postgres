...
[source,shell]
----
curl -k -X POST https://$(oc get route eap7-with-postgres --template='{{ .spec.host }}')/one
curl -k -X POST https://$(oc get route eap7-with-postgres --template='{{ .spec.host }}')/two
----
Then we can read the entries we added
[source,shell]
----
curl -k https://$(oc get route eap7-with-postgres --template='{{ .spec.host }}')
----
which should return
[source,shell]
----
...
[source,shell]
----
curl -k -X POST https://$(oc get route postgres-secret --template='{{ .spec.host }}')/one
curl -k -X POST https://$(oc get route postgres-secret --template='{{ .spec.host }}')/two
----
Then we can read the entries we added
[source,shell]
----
curl -k https://$(oc get route postgres-secret --template='{{ .spec.host }}')
----
which should return
[source,shell]
----
